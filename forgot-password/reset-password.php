    ...
    if (!empty($token)) {
        try {
            ...
            if (!$user) {
              ...
              $_SESSION['message'] = "Something went wrong, Please resend an email";
              ...
              redirect("forgot-password.php");
                ...
                if (strtotime($user["reset_token_expires_at"]) > time()) {
                    ...
                    if (!$isValid) {
                        ...
                        redirect("../login/login.php?msg=Password reset successful.");
                    }
                } else {
            ...
            $_SESSION['message'] = $e->getMessage().", Please send a new email";
            redirect('forgot-password.php');
        }
    } else {
      // If no token was found, show an error message
      $_SESSION['message'] = "Somethig when wrong, Please send a new email.";
      redirect('reset-password.php');
    }
}
?>
